function getCharacter( character, i ){
    ...
    container[ 'tomcat' ]    =   {
        ...
        classOrigin     : "eastern german privileged background nearly situated to the university with mother who worked as anastinsistion at the medac",
        type            : 'early regocnition of higher perspective had made him a lonely teen who get trough to this deeply into it issues with the new and exiting possibilities of his time with 286 and the change and the indoctrinations from this like slave tendencies to fatties (demon teeths)',
        strongs         : 'can get straight and is quite fit and can take long distances',
        maxSplits       : getRanInt( 9 ),
        binding         : 'margott & tu google',
        rang            : 'trancendency-medium',
        tasks           : '',
        scrabble        : getRanInt( 64 ),
        color           : 'green'
    }
